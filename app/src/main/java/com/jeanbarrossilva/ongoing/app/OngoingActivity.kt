...
internal class OngoingActivity: ComposableActivity() {
    ...
    private val activityDetailsBoundary by inject<ActivityDetailsBoundary>()

    @Composable
    override fun Content() {
        Ongoing(userRepository, activityRegistry, activitiesBoundary, activityDetailsBoundary)
    }
}